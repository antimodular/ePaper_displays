...
//#define GxEPD2_DRIVER_CLASS GxEPD2_213_B72 // GDEH0213B72 128x250 //use for Adafruit FeatherWing 2.13" mono colour with black ribbon clamp.
//#define GxEPD2_DRIVER_CLASS GxEPD2_213_B73 // GDEH0213B73 128x250
#define GxEPD2_DRIVER_CLASS GxEPD2_213_B74 // GDEH0213B73 128x250 //use for Adafruit FeatherWing 2.13" mono colour. important is B74
...
//use for Adafruit FeatherWing 2.13" mono colour with Huzzah
//from FeatherWing Test
//#define SRAM_CS     32
//#define EPD_CS      15
//#define EPD_DC      33
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS=4*/ 0, /*DC=*/ 15, /*RST=*/ -1, /*BUSY=*/ -1));
#endif
...
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS=4*/ 15, /*DC=*/ 33, /*RST=*/ -1, /*BUSY=*/ -1));
...
//GxEPD2_BW < GxEPD2_1248, GxEPD2_1248::HEIGHT / 4 > display(GxEPD2_1248(/*sck=*/ 36, /*miso=*/ 37, /*mosi=*/ 35,
//    /*cs_m1=*/ 8, /*cs_s1=*/ 8, /*cs_m2=*/ -1, /*cs_s2=*/ -1,
//    /*dc1=*/ 7, /*dc2=*/ -1, /*rst1=*/ 6, /*rst2=*/ -1,
//    /*busy_m1=*/ 5, /*busy_s1=*/ -1, /*busy_m2=*/ -1, /*busy_s2=*/ -1));
#endif
...
//use for Adafruit FeatherWing 2.13" mono colour with Feather M0 Express
